...
<head>
    ...
    <!-- link logo anh -->
    <link rel="icon" href="./img/logoBank/logoweb.png" type="image/x-icon">
...
<header>
    ...
    <div class="login-form" id="loginForm">
        ...
        <p class="additional-links">
            ...
            Khách hàng mới? <a href="register.html">Tạo tài khoản</a><br>
    ...
    <div class="user-menu" id="userMenu" style="display: none;">
        ...
        <ul>
            <li><a href="user.html"><i class="fas fa-box"></i>Thông tin cá nhân</a></li>
    ...
    <div class="cart-form" id="cartForm">
        ...
        <a href="card.html" class="view-cart-button">XEM GIỎ HÀNG</a>
    </div>
</header>
...
<nav class="menu-bar">
    <ul>
        <li class="active"><a href="index.html" onclick="setActive(this)"><i class="fas fa-home"></i> Trang chủ</a></li>
        <li><a href="traicayhomnay.html" onclick="setActive(this)">Trái ngon hôm nay</a></li>
        <li><a href="traicayvietnam.html" onclick="setActive(this)">Trái cây Việt Nam</a></li>
        <li><a href="traicaynhapkhau.html" onclick="setActive(this)">Trái cây nhập khẩu</a></li>
        <li><a href="traicaycatsan.html" onclick="setActive(this)">Trái cây cắt sẵn</a></li>
        <li><a href="quatangtraicay.html" onclick="setActive(this)">Quà tặng trái cây</a></li>
        <li><a href="hopqua.html" onclick="setActive(this)">Hộp quà Nguyệt Cát</a></li>
        <li><a href="traicaysaykho.html" onclick="setActive(this)">Trái cây sấy khô</a></li>
        <li><a href="muttraicay.html" onclick="setActive(this)">Mứt trái cây</a></li>
        <li><a href="contact.html" onclick="setActive(this)">Liên hệ</a></li>
    </ul>
</nav>
<!-- Menu docj ban đầu ẩn , chỉ xuất hiện khi ấn icon -->
<nav class="sidebar-menu" id="sidebarMenu">
    <ul>
        <li><a href="index.html" onclick="setActive(this)">Trang chủ</a></li>
...
<section class="home" id="home">
    <div class="swiper-container background-slider">
        <div class="swiper-wrapper">
            <div class="swiper-slide"><img src="./img/back6.webp" alt="Background 4"></div>
            <div class="swiper-slide"><img src="./img/back5.webp" alt="Background 1"></div>
            <div class="swiper-slide"><img src="./img/back2.jpg" alt="Background 2"></div>
            <div class="swiper-slide"><img src="./img/back3.jpg" alt="Background 3"></div>
            <div class="swiper-slide"><img src="./img/back3.webp" alt="Background 4"></div>
        </div>
    </div>
...
<section class="products" id="products">
    ...
    <div class="view-more-container">
        <a href="traicayhomnay.html" class="view-more" id="view-more-btn">Xem thêm sản phẩm hôm nay</a>
    </div>
</section>
<!--------------------------------------- sản phẩm việt nam ------------------------------------------------->
<section class="products" id="products">
...
<section class="products" id="products">
    ...
    <div class="swiper product-slider">
        <div class="swiper-wrapper">
            <div class="swiper-slide box">
                <img src="./img/traicaynhapkhau/lehanrima.png" alt="" />
                <h3>Lê Hàn Rima</h3>
            ...
            <div class="swiper-slide box">
                <img src="./img/traicaynhapkhau/luuisrael.png" alt="" />
                <h3>Lựu Israel</h3>
            ...
            <div class="swiper-slide box">
                <img src="./img/traicaynhapkhau/luuperu.png" alt="" />
                <h3>Lựu Peru</h3>
            ...
            <div class="swiper-slide box">
                <img src="./img/traicaynhapkhau/mandenuc.jpg" alt="" />
                <h3>Mận đen úc</h3>
                <h3 class="price">295.000đ</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
            ...
            <div class="swiper-slide box">
                <img src="./img/traicaynhapkhau/manvangmy.webp" alt="" />
                <h3>Mận vàng Mỹ</h3>
            ...
            <div class="swiper-slide box">
                <img src="./img/traicaynhapkhau/medotbot.png" alt="" />
                <h3>Me dốt bột</h3>
    ...
    <div class="swiper product-slider">
        <div class="swiper-wrapper">
            <div class="swiper-slide box">
                <img src="./img/traicaynhapkhau/methailan.jpg" alt="" />
                <h3>Me Thái Lan</h3>
            ...
            <div class="swiper-slide box">
                <img src="./img/traicaynhapkhau/nhokeodomy.png" alt="" />
                <h3>Nho kẹo đỏ Mỹ</h3>
            ...
            <div class="swiper-slide box">
                <img src="./img/traicaynhapkhau/nhomaudonhanquoc.jpg" alt="" />
            ...
            <div class="swiper-slide box">
                <img src="./img/traicaynhapkhau/nhoxanhngontayuc.png" alt="" />
            ...
            <div class="swiper-slide box">
                <img src="./img/traicaynhapkhau/nhoxanhperu.png" alt="" />
                <h3>Nho xanh Peru</h3>
            ...
            <div class="swiper-slide box">
                <img src="./img/traicaynhapkhau/taoenvynewzealand.jpg" alt="" />
    ...
    <div class="view-more-container">
        <a href="traicaynhapkhau.html" class="view-more" id="view-more-btn">Xem thêm sản phẩm nhập khẩu</a>
    </div>
</section>
<!--------------------------------------------------------------- trái cây cắt sẵn ------------------------------------------->
<section class="products" id="products">
    ...
    <div class="view-more-container">
        <a href="traicaycatsan.html" class="view-more" id="view-more-btn">Xem thêm sản phẩm cắt sẵn</a>
    </div>
</section>
<!-- quà tặng trái cây -->
<section class="products" id="products">
    ...
    <div class="view-more-container">
        <a href="quatangtraicay.html" class="view-more" id="view-more-btn">Xem thêm sản phẩm quà tặng</a>
    </div>
</section>
<section class="products" id="products">
    ...
    <div class="view-more-container">
        <a href="hopqua.html" class="view-more" id="view-more-btn">Xem thêm sản phẩm quà tặng nguyên cát</a>
    </div>
</section>
<section class="products" id="products">
    ...
    <div class="view-more-container">
        <a href="traicaysaykho.html" class="view-more" id="view-more-btn">Xem thêm sản phẩm sấy khô</a>
    </div>
</section>
<!-- Mứt -->
<section class="products" id="products">
    ...
    <div class="view-more-container">
        <a href="muttraicay.html" class="view-more" id="view-more-btn">Xem thêm sản phẩm mứt trái cây</a>
    </div>
</section>
...
<section class="categories" id="categories">
    ...
    <div class="box-container">
        <div class="box">
            <img src="./img/traicayvietnam/mam_xoi_den.webp" alt="" />
            <h3>Trái cây Việt Nam</h3>
            <p>Giảm giá tới 30%</p>
            <a href="traicayvietnam.html" class="btn">mua ngay</a>
        </div>
        <div class="box">
            <img src="./img/traicaynhapkhau/le_sua_noi_dia_trung.webp" alt="" />
            <h3>Trái cây nhập khẩu</h3>
            <p>Giảm giá tới 25%</p>
            <a href="traicaynhapkhau.html" class="btn">mua ngay</a>
        </div>
        <div class="box">
            <img src="./img/traicaycatsan/cs01.webp" alt="" />
            <h3>Trái cây cắt sẵn</h3>
            <p>Giảm giá tới 20%</p>
            <a href="traicaycatsan.html" class="btn">mua ngay</a>
        </div>
        <div class="box">
            <img src="./img/gq19.webp" alt="" />
            <h3>Quà tặng trái cây</h3>
            <p>Giảm giá tới 30%</p>
            <a href="quatangtraicay.html" class="btn">mua ngay</a>
        </div>
        <div class="box">
            <img src="./img/hqnc1.png" alt="" />
            <h3>Hộp quà nguyên cát</h3>
            <p>Giảm giá tới 30%</p>
            <a href="hopqua.html" class="btn">mua ngay</a>
        </div>
        <div class="box">
            <img src="./img/tcs1.jpg" alt="" />
            <h3>Trái cây sấy khô</h3>
            <p>Giảm giá tới 50%</p>
            <a href="traicaysaykho.html" class="btn">mua ngay</a>
        </div>
        <div class="box">
            <img src="./img/mtc1.webp" alt="" />
            <h3>Mứt trái cây</h3>
            <p>Giảm giá tới 45%</p>
            <a href="muttraicay.html" class="btn">mua ngay</a>
        </div>
    </div>
</section>
<section class="brand" id="brand">
    ...
    <div class="swiper brand-slider">
        <div class="swiper-wrapper">
            <div class="swiper-slide box">
                <img src="./img/logoBank/acb.webp" alt="" />
            </div>
            <div class="swiper-slide box">
                <img src="./img/logoBank/bidv.webp" alt="" />
            </div>
            <div class="swiper-slide box">
                <img src="./img/logoBank/helo.webp" alt="" />
            </div>
            <div class="swiper-slide box">
                <img src="./img/logoBank/map.webp" alt="" />
            </div>
            <div class="swiper-slide box">
                <img src="./img/logoBank/shahan.webp" alt="" />
            </div>
            <div class="swiper-slide box">
                <img src="./img/logoBank/bo.webp" alt="" />
            </div>
            <div class="swiper-slide box">
                <img src="./img/logoBank/ocb.webp" alt="" />
            </div>
            <div class="swiper-slide box">
                <img src="./img/logoBank/pep.webp" alt="" />
            </div>
        </div>
...
<script src="./javacript/fruit.js"></script>
